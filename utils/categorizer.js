...
5. "metafields": An array of objects extracting key product specifications (e.g., Material, Target Pet, Dimensions). Format: [{"key": "material", "value": "Plush"}]. Keys must be lowercase alphanumeric with underscores.
